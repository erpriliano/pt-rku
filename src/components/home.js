...
const Home = () => {
  return (
    <div
      ...
      id="home"
      className="max-w-screen-2xl container mx-auto flex flex-col px-6 pt-24 items-center justify-center"
    >
      <div className="w-full md:w-2/3 xl:w-3/4 flex flex-col items-center">
        <h1 className="font-Lato text-2xl md:text-3xl font-bold tracking-wide text-white mb-4">
          {companyProfile.name}
        </h1>
        <p className="font-Poppins mb-8 leading-relaxed text-sm text-center text-white">
